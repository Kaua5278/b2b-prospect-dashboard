        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select value={state} onValueChange={setState}>
                <SelectTrigger className="bg-slate-900/50 border-slate-700 focus:border-cyan-500" disabled={loadingStates}>
            ...
            <div>
              ...
              <Select value={city} onValueChange={setCity}>
                <SelectTrigger className="bg-slate-900/50 border-slate-700 focus:border-cyan-500" disabled={loadingCities || !state}>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <motion.button
              ...
              className={cn(
                'sm:w-auto w-full py-3 px-8 rounded-xl font-medium text-base transition-all shrink-0',
